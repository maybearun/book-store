...
public final class Register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <h1 class=\"title-font font-medium text-3xl text-gray-900\">Register Now!!</h1>\n");
      out.write("                    <p class=\"leading-relaxed mt-4\">Join millions now in enjoying just by registering here <br> and Avail all the benefits.</p>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0\">\n");
      out.write("                    <h2 class=\"text-gray-900 text-lg font-medium title-font mb-5\">Register</h2>\n");
      out.write("                    <form >\n");
      out.write("                        <div class=\"relative mb-4\">\n");
      out.write("                            <label for=\"uid\" class=\"leading-7 text-sm text-gray-600\">uid</label>\n");
      out.write("                            <input type=\"text\" id=\"uid\" name=\"uid\" class=\"w-full bg-white rounded border border-gray-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out\">\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"relative mb-4\">\n");
      out.write("                            <label for=\"name\" class=\"leading-7 text-sm text-gray-600\">Name</label>\n");
      out.write("                            <input type=\"text\" id=\"name\" name=\"name\" class=\"w-full bg-white rounded border border-gray-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out\">\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"relative mb-4\">\n");
      ...
      out.write("                        </div>\n");
      out.write("                        <button class=\"text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg\">Register</button>\n");
      out.write("                        <p class=\"text-xs text-gray-500 mt-3\">Literally you probably haven't heard of them Book worms.</p>\n");
      out.write("                        ");
